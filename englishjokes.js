...
function randomEnglishJokes(){
    var randomNumber = Math.floor(Math.random() * (englishJokes.length));
    document.getElementById("displayEnglishJokes").innerHTML = englishJokes[randomNumber];
}